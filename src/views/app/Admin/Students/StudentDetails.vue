...
export default {
    ...
    mounted() {
        const self = this;
        axios.get(`http://46.101.188.213:5000/api/admin/student/${this.$route.params.id}`)
            .then((res)=>{
                self.user=res.data;
    ...
    methods: {
        assignSection(){
            axios.post(`http://46.101.188.213:5000/api/admin/student-in-section/${this.selectedSection.value}/${this.$route.params.id}`,
                    {
        ...
        paymentAdd() {
                ...
                axios.post(`http://46.101.188.213:5000/api/admin/student/payment/${this.$route.params.id}`, formData,
                    {
            ...
            deleteUser(){
                axios.delete(`http://46.101.188.213:5000/api/admin/student/${this.$route.params.id}`)
                    .then(()=>{
