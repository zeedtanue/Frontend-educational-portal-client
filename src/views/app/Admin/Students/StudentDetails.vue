...
export default {
    ...
    mounted() {
        const self = this;
        axios.get(`http://localhost:5000/api/admin/student/${this.$route.params.id}`)
            .then((res)=>{
                self.user=res.data;
    ...
    methods: {
        assignSection(){
            axios.post(`http://localhost:5000/api/admin/student-in-section/${this.selectedSection.value}/${this.$route.params.id}`,
                    {
        ...
        paymentAdd() {
                ...
                axios.post(`http://localhost:5000/api/admin/student/payment/${this.$route.params.id}`, formData,
                    {
            ...
            deleteUser(){
                axios.delete(`http://localhost:5000/api/admin/student/${this.$route.params.id}`)
                    .then(()=>{
