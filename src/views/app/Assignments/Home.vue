...
export default {
    ...
    mounted() {
        const self = this;
        axios.get(`https://creatixa-student-portal.herokuapp.com/api/admin/class/get-task/${this.$route.params.id}`)
            .then((res)=>{
        ...
        axios.get(` https://creatixa-student-portal.herokuapp.com/api/teacher/class/task/${this.$route.params.id}/submissions`,{
            headers:{
                'Authorization': token
            }
        })
    ...
    methods: {
        registerIt() {
                ...
                axios.post(`https://creatixa-student-portal.herokuapp.com/api/student/assignments/${this.$route.params.id}`, formData,
                    {
                        headers: {
