...
export default {
    ...
    methods:{
            ...
            resourceRegisterIt(){
                ...
                axios.post(`http://46.101.188.213:5000/api/teacher/class/resource/${this.$route.params.id}`, formData,
                    {
                        headers: {
			...
			registerIt() {
                ...
                axios.post(`http://46.101.188.213:5000/api/teacher/class/task/${this.$route.params.id}`, formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data',
                            'Authorization': token
